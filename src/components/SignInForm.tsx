        ...
        <div className="bg-[#161616] rounded-2xl border border-white/5 p-8">
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              disabled={submitting}
              className="w-full px-4 py-3 rounded-xl bg-[#1E1E1E] border border-white/10 text-neutral-300 font-medium hover:bg-[#252525] hover:border-white/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
            >
